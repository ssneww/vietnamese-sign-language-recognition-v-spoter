...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        if args.save_checkpoints:
            if train_acc > top_train_acc or epoch % 10==0:
...
# python -m train --experiment_name "my_experimentWLASL100_3" --epochs 200 --lr 0.001 --training_set_path "train_WLASL100_3.csv" --validation_set_path "test_WLASL100.csv" --testing_set_path "test_WLASL100.csv" --num_classes 100